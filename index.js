...
function counter() {
    document.querySelector("#todo-counter").textContent = countTaskByStatus("To do");
    document.querySelector("#inProgress-counter").textContent = countTaskByStatus("In Progress");
    document.querySelector("#stuck-counter").textContent = countTaskByStatus("Stuck");
    document.querySelector("#done-counter").textContent = countTaskByStatus("Done");
};
...
function removeTask(id) {
    ...
    if (element) {
        element.remove();
        data = data.filter(i => { return i.id !== id; });
    }
    Updatecounter();
};
// edit cards   
    ...
    board.addEventListener('dragenter', (event) => {
        ...
        if (draggedItem) {
            if (draggedItem !== event.currentTarget) {
                ...
                console.log(id);
                event.currentTarget.querySelector('.all-cards').appendChild(draggedItem);
                if ( status === 'To do') {
